...
package eventstore.client.proto
...
final case class NewEvent (
	...
	lazy val getSerializedSize = {
		...
		if (`eventType`.isDefined) size += computeStringSize(2, `eventType`.get)
	...
	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): NewEvent = {
		...
		var __eventType: Option[String] = `eventType`
...
final case class EventRecord (
	...
	def writeTo(output: com.google.protobuf.CodedOutputStream) {
		...
		if (`eventType`.isDefined) output.writeString(4, `eventType`.get)
	...
	lazy val getSerializedSize = {
		...
		if (`eventType`.isDefined) size += computeStringSize(4, `eventType`.get)
...
final case class DeniedToRoute (
	...
	`externalHttpPort`: Int = 0
	 ...
	 with com.google.protobuf.MessageLite.Builder
	with net.sandrogrzicic.scalabuff.Message[DeniedToRoute] {
	...
	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): DeniedToRoute = {
		import com.google.protobuf.ExtensionRegistryLite.{getEmptyRegistry => _emptyRegistry}
	...
	def getDefaultInstanceForType = DeniedToRoute.defaultInstance
	def clear = getDefaultInstanceForType
	def isInitialized = true
	def build = this
	def buildPartial = this
...
object DeniedToRoute {
	@reflect.BeanProperty val defaultInstance = new DeniedToRoute()
...
final case class CreateStream (
	`eventStreamId`: String = "",
	`requestId`: com.google.protobuf.ByteString = com.google.protobuf.ByteString.EMPTY,
	`metadata`: Option[com.google.protobuf.ByteString] = None,
	`allowForwarding`: Boolean = false,
	`isJson`: Boolean = false
) extends com.google.protobuf.GeneratedMessageLite
	 with com.google.protobuf.MessageLite.Builder
	with net.sandrogrzicic.scalabuff.Message[CreateStream] {
	...
	def writeTo(output: com.google.protobuf.CodedOutputStream) {
		output.writeString(1, `eventStreamId`)
		output.writeBytes(2, `requestId`)
		if (`metadata`.isDefined) output.writeBytes(3, `metadata`.get)
		output.writeBool(4, `allowForwarding`)
		output.writeBool(5, `isJson`)
	}
	...
	lazy val getSerializedSize = {
		...
		var size = 0
		size += computeStringSize(1, `eventStreamId`)
		size += computeBytesSize(2, `requestId`)
		if (`metadata`.isDefined) size += computeBytesSize(3, `metadata`.get)
		size += computeBoolSize(4, `allowForwarding`)
		size += computeBoolSize(5, `isJson`)

		size
	}

	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): CreateStream = {
		import com.google.protobuf.ExtensionRegistryLite.{getEmptyRegistry => _emptyRegistry}
		var __eventStreamId: String = ""
		var __requestId: com.google.protobuf.ByteString = com.google.protobuf.ByteString.EMPTY
		var __metadata: Option[com.google.protobuf.ByteString] = `metadata`
		var __allowForwarding: Boolean = false
		var __isJson: Boolean = false

		def __newMerged = CreateStream(
			__eventStreamId,
			__requestId,
			__metadata,
			__allowForwarding,
		...
		while (true) in.readTag match {
			case 0 => return __newMerged
			case 10 => __eventStreamId = in.readString()
			case 18 => __requestId = in.readBytes()
			case 26 => __metadata = in.readBytes()
			case 32 => __allowForwarding = in.readBool()
			case 40 => __isJson = in.readBool()
			case default => if (!in.skipField(default)) return __newMerged
		}
		null
	}

	def mergeFrom(m: CreateStream) = {
		CreateStream(
			m.`eventStreamId`,
			m.`requestId`,
			m.`metadata`.orElse(`metadata`),
	...
	def getDefaultInstanceForType = CreateStream.defaultInstance
	def clear = getDefaultInstanceForType
	def isInitialized = true
	def build = this
	def buildPartial = this
...
object CreateStream {
	@reflect.BeanProperty val defaultInstance = new CreateStream()

	val EVENT_STREAM_ID_FIELD_NUMBER = 1
	val REQUEST_ID_FIELD_NUMBER = 2
	val METADATA_FIELD_NUMBER = 3
	val ALLOW_FORWARDING_FIELD_NUMBER = 4
	val IS_JSON_FIELD_NUMBER = 5

}
final case class CreateStreamCompleted (
	`result`: OperationResult.EnumVal = OperationResult._UNINITIALIZED,
	`message`: Option[String] = None
) extends com.google.protobuf.GeneratedMessageLite
	 with com.google.protobuf.MessageLite.Builder
	with net.sandrogrzicic.scalabuff.Message[CreateStreamCompleted] {
	...
	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): CreateStreamCompleted = {
		import com.google.protobuf.ExtensionRegistryLite.{getEmptyRegistry => _emptyRegistry}
		var __result: OperationResult.EnumVal = OperationResult._UNINITIALIZED
		var __message: Option[String] = `message`

		def __newMerged = CreateStreamCompleted(
			__result,
			__message
		)
		while (true) in.readTag match {
	...
	def mergeFrom(m: CreateStreamCompleted) = {
	...
	def getDefaultInstanceForType = CreateStreamCompleted.defaultInstance
	def clear = getDefaultInstanceForType
	def isInitialized = true
	def build = this
	def buildPartial = this
...
object CreateStreamCompleted {
	@reflect.BeanProperty val defaultInstance = new CreateStreamCompleted()
...
final case class DeleteStream (
	...
	def writeTo(output: com.google.protobuf.CodedOutputStream) {
		output.writeString(1, `eventStreamId`)
		output.writeInt32(2, `expectedVersion`)
		output.writeBool(3, `allowForwarding`)
	}
	...
	lazy val getSerializedSize = {
		...
		size += computeStringSize(1, `eventStreamId`)
		size += computeInt32Size(2, `expectedVersion`)
		size += computeBoolSize(3, `allowForwarding`)
	...
	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): DeleteStream = {
		...
		while (true) in.readTag match {
			...
			case 10 => __eventStreamId = in.readString()
			case 16 => __expectedVersion = in.readInt32()
			case 24 => __allowForwarding = in.readBool()
			case default => if (!in.skipField(default)) return __newMerged
		}
		null
	}
...
object DeleteStream {
	...
	val EVENT_STREAM_ID_FIELD_NUMBER = 1
	val EXPECTED_VERSION_FIELD_NUMBER = 2
	val ALLOW_FORWARDING_FIELD_NUMBER = 3
...
final case class TransactionCommit (
	...
	def writeTo(output: com.google.protobuf.CodedOutputStream) {
		output.writeInt64(1, `transactionId`)
		output.writeBool(2, `allowForwarding`)
	}
	...
	lazy val getSerializedSize = {
		...
		var size = 0
		size += computeInt64Size(1, `transactionId`)
		size += computeBoolSize(2, `allowForwarding`)
	...
	def mergeFrom(in: com.google.protobuf.CodedInputStream, extensionRegistry: com.google.protobuf.ExtensionRegistryLite): TransactionCommit = {
		...
		while (true) in.readTag match {
			case 0 => return __newMerged
			case 8 => __transactionId = in.readInt64()
			case 16 => __allowForwarding = in.readBool()
			case default => if (!in.skipField(default)) return __newMerged
		}
		null
	}
...
object TransactionCommit {
	...
	val TRANSACTION_ID_FIELD_NUMBER = 1
	val ALLOW_FORWARDING_FIELD_NUMBER = 2
