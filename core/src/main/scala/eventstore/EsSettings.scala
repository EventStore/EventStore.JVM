...
import EsSettings.HttpSettings
 ...
 * @param cluster see [[eventstore.cluster.ClusterSettings]]
 * @param http see [[eventstore.EsSettings.HttpSettings]]
...
object EsSettings {
  ...
  lazy val Default: EsSettings = EsSettings(ConfigFactory.load())
   ...
   * Java API
   */
  def getInstance(): EsSettings = Default
  ...
  object HttpSettings {
    ...
    lazy val Default = HttpSettings("http", "127.0.0.1", 2113, "")
