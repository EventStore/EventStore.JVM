...
class ZonedDateTimeDecoderSpec extends Specification {
  ...
  "DateFormat" should {
    ...
    "parse 2021-12-23T02:08:17.448-10:00[America/Adak]" in {
      val str = "2021-12-23T02:08:17.448-10:00[America/Adak]"
      val expected = ZonedDateTime.of(2021, 12, 23, 12, 8, 17, 448 * 1000000, ZoneOffset.UTC)
      codecForZDT(Json.fromString(str).hcursor).toOption must beSome(expected)
    }
